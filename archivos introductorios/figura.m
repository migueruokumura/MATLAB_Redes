...
% Last Modified by GUIDE v2.5 31-Jan-2020 11:00:16
...
regla_bit_alto = str2num(get(handles.txt,'String'));
...
axes(hanles.axes2)
plot(cadenaBits) %la de voltaje, no seria voltios
...
% --- Executes on button press in regla.
